...
export default function Footer() {
  return (
    <footer className="pt-24 pb-12 border-t border-navy bg-navy text-white overflow-hidden relative">
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[radial-gradient(circle,_#E8743B15_0%,_transparent_70%)] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16 mb-16">
          <div className="md:col-span-1">
            <div className="inline-flex items-center gap-3 mb-6 bg-white p-3 rounded-xl">
              <img src="/logo.png" alt="Kreate UI" className="h-8 w-auto" />
              {/* <span className="text-xl font-bold font-[var(--font-display)] tracking-tight">Kreate UI</span> */}
            </div>
            <p className="text-white/60 text-sm leading-relaxed max-w-xs">
              The AI-powered ecosystem for generating accessible, high-performance web interfaces in seconds.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/60">
              ...
              <li><Link to="/guides" className="hover:text-primary transition-colors">Accessibility Guides</Link></li>
