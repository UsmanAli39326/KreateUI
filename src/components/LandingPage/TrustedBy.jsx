export default function TrustedBy() {
  return (
    <section className="border-y border-border-1 py-10 sm:py-12 bg-bg-1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-center text-[11px] sm:text-xs font-bold uppercase tracking-[0.2em] text-text-3 mb-8 sm:mb-10">
          Trusted by technical teams worldwide
        </p>

        <div className="flex flex-wrap justify-center items-center text-navy gap-8 sm:gap-10 md:gap-14 lg:gap-20 opacity-30">
